...
## License Notice
````
berryhood-diagrams - Diagrams for the berryhood project
Copyright (c) 2018 by Advay Mengle - https://github.com/berryhood-diagrams
...
The following applies to each file containing ".fritzing." in its name:

    This image was created with Fritzing - https://github.com/fritzing/fritzing-app

    This work is licensed under the Creative Commons Attribution-ShareAlike 3.0 Unported License.
    To view a copy of this license, visit http://creativecommons.org/licenses/by-sa/3.0/.

The following applies to everything else:
